        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
            ...
            <div class="hover:scale-105 transition-transform duration-300"> 
                <a href="/" wire:navigate>
                    <x-application-logo class="w-20 h-24 fill-current" /> 
                </a>
            </div>
            ...
            <p class="mt-6 text-xs text-gray-400 uppercase tracking-widest font-bold">
                &copy; {{ date('Y') }} Zenith Support - Gestión de Taller
            </p>
        </div>
    </body>
</html>